...
int	Write_CaliMeter_Config(void)
{
	...
	Writer : OYS\n
	================================================================================\n
	comPort				=> Serial Port No. (Default : 1)\n
comBps				=> Communication Speed (Default : 9600)\n
CmdSendLog			=> CmdSendLog Print Flag\n
CmdRcvLog			=> CmdRcvLog Print Flag\n
CmdSendLog_Hex		=> CmdSendLog_Hex Print Flag\n
CmdRcvLog_Hex		=> CmdRcvLog_Hex Print Flag\n
CommCheckLog		=> CommunicationChekLog Print Flag\n
readType			=> Read Type\n
						0 : READ_V_V\n
						1 : READ_V_I\n\n
...
I_offset			=> (Default : 0)\n
Shunt_Sel_Cali		=> Shunt Select Calibrator (Default : 1)\n
Lan_Use				=> CaliMeter Select (34401A / 34461A)\n
						0 : 34401A Use 232 protocal\n
						1 : 34461A Use Lan Port\n
						2 : 34461A Use 232 to Lan Converter\n\n
					
CaliMeterIp 		=> 34461A IP Setting\n
MeterSock_Port		=> 34461A Lan Socket Port Setting \n");
	fclose(fp);
	return 0;
}
